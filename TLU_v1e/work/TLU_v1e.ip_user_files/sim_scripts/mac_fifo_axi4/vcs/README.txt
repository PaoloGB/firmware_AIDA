...
#
# Generated by export_simulation on Thu Aug 17 14:05:01 BST 2017
#
################################################################################
...
switch to the './mac_fifo_axi4.sh' script.

./mac_fifo_axi4.sh -reset_run
...
./mac_fifo_axi4.sh -noclean_files

For more information on the script, please type './mac_fifo_axi4.sh -help'.
