...
HD_PWD='/users/phpgb/workspace/myFirmware/AIDA/TLU_v1e/work/TLU_v1e.runs/tlu_event_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tlu_event_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tlu_event_fifo.tcl
