...
HD_PWD='/users/phpgb/workspace/myFirmware/AIDA/TLU_v1e/work/TLU_v1e.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_tlu_v1e.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_tlu_v1e.tcl
