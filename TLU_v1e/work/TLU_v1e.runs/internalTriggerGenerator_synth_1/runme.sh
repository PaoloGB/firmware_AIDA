...
HD_PWD='/users/phpgb/workspace/myFirmware/AIDA/TLU_v1e/work/TLU_v1e.runs/internalTriggerGenerator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log internalTriggerGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source internalTriggerGenerator.tcl
