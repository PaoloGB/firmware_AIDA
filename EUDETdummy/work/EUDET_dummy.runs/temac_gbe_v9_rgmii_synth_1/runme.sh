...
HD_PWD='/users/phpgb/workspace/myFirmware/AIDA/EUDETdummy/work/EUDET_dummy.runs/temac_gbe_v9_rgmii_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temac_gbe_v9_rgmii.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temac_gbe_v9_rgmii.tcl
